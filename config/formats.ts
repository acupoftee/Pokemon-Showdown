...
export const Formats: import("../sim/dex-formats").FormatList = [
	// Sacred Gold / Storm Silver Singles
	///////////////////////////////////////////////////////////////////
	{
		section: "Steam Games",
	},
	{
		name: "[SGSS] Sacred Gold & Storm Silver OU",
	...
	},
	{
		...
		onBegin() {
			this.add(
				`raw|<div class='broadcast-green'><b>Need help with all of the new moves, abilities, and wacky stuff?<br />Then make sure to check out the <a href="https://docs.google.com/spreadsheets/d/1gE9pr0ghm1_Y8kPk0c-jXP93X57xlEr1OzzyXUVH90w/edit#gid=0" target="_blank">spookymod Spreadsheet</a> or use /dt!</b></div>`
			);
		},
